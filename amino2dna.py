...
'''
Codon Usage Reference : http://www.kazusa.or.jp/codon/cgi-bin/showcodon.cgi?species=9606
frequency of each codon in 'genoeme' was converted into probability occurence in each amino-acid.
'''
